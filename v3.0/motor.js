...
const html = {
    ...
    exibirCalendarioDaGsv: function(ano){
        ...
        let periodoMes = [];
        const aux = new Date(`${parseInt(ano)+1}-01-01T00:00:00`);
        ...
        function _criarMes(d0){
            if (!$('divCalGsvMes_' + d0.getMonth())){
                ...
                divMesCalGsv.innerHTML = `<label class='clsdivCalGsvMesLabel'>${_extrairMesExtenso(d0.toLocaleDateString()).toUpperCase()} - ${d0.getFullYear()}</label>`+ 
        ...
        function _inserirLegenda(){
            ...
            divLegContainer.style.display = 'grid';
            divLegContainer.style.gridTemplateColumns = '35px 1fr';

            divLegContainer.style.border = '2px solid black';
            divLegContainer.style.gridColumn = '1/4';
            divLegContainer.style.padding = '5px';
